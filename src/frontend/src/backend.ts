...
export class Backend implements backendInterface {
    ...
    async getAllYearsTotalToNow(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllYearsTotalToNow();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDailyTotal(arg0: Time): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getMonthlyTotalToNow(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getMonthlyTotalToNow();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getYearlyTotalToNow(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getYearlyTotalToNow();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateExpense(arg0: ExpenseId, arg1: ExpenseInput): Promise<Expense> {
        if (this.processError) {
            try {
